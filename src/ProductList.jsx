...
function ProductList({ onHomeClick }) {
    ...
    const handleAddToCart = (product) => {
        ...
        console.log(`${product.name} added to cart (via Redux)`);
    };
                ...
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)}>
                            <div><h3 style={{ color: 'white' }}>Paradise Nursery</h3><i style={{ color: 'white' }}>Where Green Meets Serenity</i></div>
                        </a>
                    </div>
                </div>
                        ...
                        <div key={index}>
                            ...
                            <div className="plants-card">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-image" key={plantIndex}>
